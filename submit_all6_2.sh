...
if_types=("twil" "idif")
proc="proc-delay0-BrainMoCo2-createNiftiMovingAvgFrames*-ParcSchaeffer-reshape-to-schaeffer-select-4.nii.gz"
submit_main="${HOME}/PycharmProjects/dynesty/idif2024/submit_main_async6_2.sh"
Nparcels=4
